...
const OtherProfile = () => {
  const {auth,cook,cookies2 , setFnp,setSideNav ,setBooleanErrHome,setHomeErr,setCook,setCookies2, setAllowCookies,displayHeader,setDisplayHeader} =useContext(AuthContext)
        ...
        <div className='profile_wrapper'>
          <div className='cover_image'>
            <div className='cvr-img'>
              {userAuth.coverImage ? <img src={userAuth.coverImage} className='img'/> :<></>}
