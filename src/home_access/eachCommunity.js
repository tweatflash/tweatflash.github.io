                ...
                <div className='cvr-img'>
                  ...
                  <div className='profile_image comm-prf'>
                    <div className='prf-img '>
                      {comm.profileImage ?<AsyncImage
                        src={comm.profileImage}
                        Transition={Blur}
                        style={{ width: "100%", height: "100%", borderRadius: "0%" }}
                        loader={<div style={{ background: '#888' }}></div>}/>  : <img style={ width <= 450 ? {width:"90px", height:"90px"}: {width:"100%", height:"100%"} } src={profileImg}/>}
                    </div>
                            ...
                            <div className='post-list'>
                                {eachCommPosts && !pL ? 
                                    <div className='posts-order-wrapper'>
                                        {eachCommPosts.map((item,index)=>(<Feed item={item}/>))}                                                                                                                                                                                                                                                                                                                                                                 
