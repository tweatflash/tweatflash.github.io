...
const CreatePosts = () => {
    ...
    const {cook,cookies2,setUploadPost,setBooleanErrHome,setHomeErr,setDisplayHeader,displayHeader}=useContext(AuthContext)
    ...
    useEffect(()=>{
      selectedFiles.length ? setvalidText(true) :setvalidText(false)
        ...
        <div className='create-container'>
            ...
            <div className='posts-optipons'>
                <div className='post-option-container'>
                    ...
                    <div className='create-action'>
                        <svg fill="#ffffff"  className="hash" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g data-name="Layer 2"> <g data-name="hash"> <rect width="24" height="24" transform="rotate(180 12 12)" opacity="0"></rect> <path d="M20 14h-4.3l.73-4H20a1 1 0 0 0 0-2h-3.21l.69-3.81A1 1 0 0 0 16.64 3a1 1 0 0 0-1.22.82L14.67 8h-3.88l.69-3.81A1 1 0 0 0 10.64 3a1 1 0 0 0-1.22.82L8.67 8H4a1 1 0 0 0 0 2h4.3l-.73 4H4a1 1 0 0 0 0 2h3.21l-.69 3.81A1 1 0 0 0 7.36 21a1 1 0 0 0 1.22-.82L9.33 16h3.88l-.69 3.81a1 1 0 0 0 .84 1.19 1 1 0 0 0 1.22-.82l.75-4.18H20a1 1 0 0 0 0-2zM9.7 14l.73-4h3.87l-.73 4z"></path> </g> </g> </g></svg>
                    </div>
                    <div className='create-action'>
                        <svg className='hash' viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M7 11h7v2H7zm0-4h10.97v2H7zm0 8h13v2H7zM4 4h2v16H4z"></path></g></svg>
                    </div>
                </div>
            </div>
        </div>
