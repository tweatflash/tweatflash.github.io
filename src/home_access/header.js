...
const Header = () => {
    ...
    const {userAuth,auth,setSideNav}=useContext(AuthContext)
          ...
          <div className='header_navigation'>
            ...
            <div className='set2'>
              <div className='profile-dp'>
                {auth && userAuth ? <img src={userAuth.profileImage} /> : <img style={{width:"100%"}} src={profileImg}/>}
              </div>
              {
                mobile? <div className='notification'>
