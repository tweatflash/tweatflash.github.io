...
const Feed = ({item,index ,type,setComments}) => {
    ...
    indexing = 0,
    newPosts=[]
    const {auth,cook,cookies2 , imgUrl,setImgUrl,userAuth,setBooleanErrHome,setHomeErr,setCook,setCookies2, setAllowCookies,im,setIm,setCommentsPrawler,setShowComments,setPostId} =useContext(AuthContext)
                        ...
                        <div className='reaction-posts'>
                            ...
                            <div className='svg-wrpr'>
                                ...
                                <div className='svg-wrpr' onClick={()=>sendATweatstar(item._id,item.user._id)}>
                                    <svg viewBox="0 0 24 24" stroke='orange' fill="orange"><g stroke-width="0"></g><g stroke-linecap="round" stroke-linejoin="round"></g><g> <path d="M12 3C12 7.97056 16.0294 12 21 12C16.0294 12 12 16.0294 12 21C12 16.0294 7.97056 12 3 12C5.6655 12 8.06036 10.8412 9.70832 9"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>&nbsp;<span>{item.tweatstars}</span>
