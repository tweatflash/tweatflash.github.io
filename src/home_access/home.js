...
const Home = () => {
    ...
    useEffect(()=>{
        ...
        // e.preventDefault();
        let x =eCordinate[0], y = eCordinate[1]
    ...
    const [post,setPost]=useState(false)
     return (
        <div className='main_data_extractor'>
            {sidenav ? <div className={`css083yewe ${sidenav? "collapse" :""}`}>
                    ...
                    <div className='sd-nav'>
                        <div className='sd-nav-header'>
                            ...
                            <div className='sd-nav-close' onClick={()=>setSideNav(false)}>
                                <svg  viewBox="0 0 512 512" ><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>cancel</title> <g id="Page-1" stroke="none" strokeWidth="1"   l="none" fill-rule="evenodd"> <g id="work-case" fill="#000000" transform="translate(91.520000, 91.520000)"> <polygon id="Close" points="328.96 30.2933333 298.666667 1.42108547e-14 164.48 134.4 30.2933333 1.42108547e-14 1.42108547e-14 30.2933333 134.4 164.48 1.42108547e-14 298.666667 30.2933333 328.96 164.48 194.56 298.666667 328.96 328.96 298.666667 194.56 164.48"> </polygon> </g> </g> </g></svg>
                            </div>
                        </div>
                        <div className='sd-nav-body'>
                            <div className='nav-cnt-cont'>
                                <div className='sd-phI'>
                                    {
                ...
                <div className='main'>
                    ...
                    <div className='css0000_main'>
                        ...
                        <div className='add_posts'></div>
                            ...
                            {focusMagic ? <div className='f-mg'></div> :<></>}
                            {width <=550 ? <div className='mobile_feed_nav'>
