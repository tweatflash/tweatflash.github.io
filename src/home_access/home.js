...
const Home = () => {
    ...
    const {auth, homeErr,booleanErrHome,showComments,setShowComments, commentsPrawler,setCommentsPrawler,sidenav,setSideNav,setImgUrl,focusMagic, imgUrl,im,setIm}=useContext(AuthContext)
                ...
                <div className='main'>
                    ...
                    <div className='css0000_main'>
                        ...
                        <div className='add_posts'></div>
                            ...
                            <CommentsPage commentsPrawler={commentsPrawler}/>
                            
                            <div className={`more-psts-option`} tabIndex={2}>
